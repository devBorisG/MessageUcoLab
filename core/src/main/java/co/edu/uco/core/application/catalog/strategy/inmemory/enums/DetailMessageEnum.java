...
public enum DetailMessageEnum {
    ...
    FUN_006(MessageKeyEnum.FUN_006, "Message not found in cache", "The message was not found in cache, we proceed to search in database", MessageTypeEnum.FUNCTIONAL, MessageCategoryEnum.WARNING),
    FUN_007(MessageKeyEnum.FUN_007, "Message found in cache", "Messages were found in the database, proceed to return and cache.", MessageTypeEnum.FUNCTIONAL, MessageCategoryEnum.WARNING),
    ...
    FUN_016(MessageKeyEnum.FUN_016, "Error during cache connection", "Data access exception while connecting to Redis", MessageTypeEnum.FUNCTIONAL, MessageCategoryEnum.ERROR),
